...
def pretty_labels(direction=False, locale=None):
    ...
    if direction:
        ...
        pretty = [
            ...
            pgettext("plotting", "Maximize the number of alive, non ID anaemic children"),
            pgettext("plotting", "Maximize the number of alive, non wasted children"),
            pgettext("plotting", "Maximize the number of alive, healthy children"),
        ...
        pretty = [
            ...
            pgettext("plotting", "Number of alive, non-ID anaemic children turning age 5"),
            pgettext("plotting", "Number of alive, non-wasted children turning age 5"),
            pgettext("plotting", "Number of alive, healthy children turning age 5"),
            ...
            pgettext("plotting", "Economic benefits of early breastfeeding (discounted)"),
