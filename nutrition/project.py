...
class Project(object):
    ...
    def run_optim(self, optim=None, key=-1, maxiter=30, swarmsize=None, maxtime=450, parallel=False, dosave=True, runbaseline=True, runbalanced=False, n_samples=0, seed=None):
        _ = utils.get_translator(self.locale)
    ...
    def run_geo(self, geo=None, key=-1, maxiter=40, swarmsize=None, maxtime=300, dosave=True, parallel=False, runbalanced=False, n_samples=0, seed=None):
