...
stunt_progs = {'Balanced energy-protein supplementation': cov,
                        ...
                        'Vitamin A supplementation': cov, 'Zinc supplementation': cov}
wast_progs = {'Balanced energy-protein supplementation': cov,
                       'IFAS for pregnant women (community)': cov,
                       'IYCF 1': cov, 'Kangaroo mother care': cov, 'Lipid-based nutrition supplements': cov,
                       'Multiple micronutrient supplementation': cov,
                       'Zinc for treatment + ORS': cov, 'Public provision of complementary foods': cov,
                       'Treatment of SAM': cov,
                       'Vitamin A supplementation': cov, 'Zinc supplementation': cov}
anaem_progs = {'Delayed cord clamping': cov, 'IFA fortification of maize': cov,
...
mort_progs = {'IFA fortification of maize': cov,
                       'IFAS for pregnant women (community)': cov,
                       'IYCF 1': cov, 'Kangaroo mother care': cov, 'Lipid-based nutrition supplements': cov,
                       'Multiple micronutrient supplementation': cov,
                       'Zinc for treatment + ORS': cov, 'Public provision of complementary foods': cov,
...
for o, outcome in enumerate(['stunting', 'wasting', 'anaemia', 'mortality']):
    effective_progs = {}
    objective_progs = sc.dcp(progval) #different_progs[o]
...
print(prog_choices)
CE_book = xw.Workbook('LBC_Global_cost_effectiveness17102019.xlsx')
