...
kwargs1 = {"name": "Treat SAM 100%", "model_name": "eg", "scen_type": "coverage", "progvals": sc.odict({"Treatment of SAM": [1]})}

kwargs2 = sc.dcp(kwargs1)
kwargs2.update({"name": "IYCF 1 100%", "progvals": sc.odict({"IYCF 1": [1]})})

kwargs3 = {"name": "IYCF at $10 mil", "model_name": "eg", "scen_type": "budget", "progvals": sc.odict({"IYCF 1": [1e7], "IPTp": [1e7]})}
...
kwargs6 = {"name": "Check bednets", "model_name": "eg", "scen_type": "budget", "progvals": sc.odict({"IYCF 1": [0]})}
