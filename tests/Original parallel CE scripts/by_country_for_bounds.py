...
def run_analysis(country):
    ...
    prog_list = ['Balanced energy-protein supplementation', 'Calcium supplementation',
                 ...
                 'IFAS for pregnant women (community)', 'IPTp',
    ...
    p.load_data(country='lbe_costed_baseline_' + country, name=country, time_trend=False)
...
CE_book = xw.Workbook('LBE_Country_CE_10112019.xlsx')
