...
kwargs = {"name": "test1", "modelnames": ["PNG_Highlands", "PNG_Islands", "PNG_Southern"], "weights": "child_deaths", "fix_curr": False, "fix_regionalspend": False, "add_funds": 5e6, "prog_set": ["IFA fortification of maize", "IYCF 1", "Lipid-based nutrition supplements", "Multiple micronutrient supplementation", "Micronutrient powders", "Kangaroo mother care", "Public provision of complementary foods", "Treatment of SAM", "Vitamin A supplementation", "Mg for eclampsia", "Zinc supplementation", "Iron and iodine fortification of salt"][:3]}  # 'PNG_Momase'],
...
for i in list(range(7)):
    ...
    run_optim = partial(p.run_optim, key=-1, maxiter=4, swarmsize=4, maxtime=15, parallel=False, dosave=True, runbaseline=False)
