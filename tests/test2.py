...
nutrition_specific = ["IYCF 1", "IFAS for pregnant women (health facility)", "Multiple micronutrient supplementation", "Micronutrient powders", "Treatment of SAM", "Vitamin A supplementation", "Zinc for treatment + ORS"]

nutrition_all = ["IYCF 1", "IFAS for pregnant women (health facility)", "IPTp", "Long-lasting insecticide-treated bednets", "Multiple micronutrient supplementation", "Micronutrient powders", "Treatment of SAM", "Vitamin A supplementation", "Zinc for treatment + ORS"]
...
def parallel_optim(progs, region, path=None, fixed=False, additional=0):
    ...
    kwargs = {"name": region, "mults": [1], "model_name": region, "weights": sc.odict({"thrive": [1, 0.5]}), "prog_set": progs, "fix_curr": fixed, "add_funds": additional}
