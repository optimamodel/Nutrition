...
export default {
  ...
  methods: {
    ...
    addOptimModal() {
      ...
      sciris.rpc('get_default_optim', [this.projectID])
        .then(response => {
    ...
    runOptim(optimSummary, runtype) {
      ...
      sciris.rpc('set_optim_info', [this.projectID, this.optimSummaries]) // Make sure they're saved first
        .then(response => {
          sciris.rpc('launch_task', [optimSummary.serverDatastoreId, 'run_optim',
    ...
    plotOptimization(optimSummary) {
      ...
      sciris.start(this)
      sciris.rpc('plot_optimization', [this.projectID, optimSummary.serverDatastoreId])
        .then(response => {
