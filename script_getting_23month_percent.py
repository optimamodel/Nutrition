...
for region in range(len(regionNameList)):
    ...
    print (pop_1 + pop_1_5 + pop_6_11 + pop_12_23) / pop_24_59
    percentlist.append((pop_1 + pop_1_5 + pop_6_11 + pop_12_23) / pop_24_59)
    U5_init.append(pop_1 + pop_1_5 + pop_6_11 + pop_12_23 + pop_24_59)
...
export['population 23-59 month'] = pd.DataFrame(pop_23_59)
