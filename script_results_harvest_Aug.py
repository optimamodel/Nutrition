...
#GAFile1 = 'GA'
#GAFile2 = 'GA_extra_'+str(extraMoney) 
#geospatialOptimisation.plotPostGAReallocationByRegion(GAFile1)
#geospatialOptimisation.plotTimeSeriesPostGAReallocationByRegion(GAFile1)
